...
export const AboutWindow = () => {
  return (
    <div className="space-y-4 md:space-y-6">
      ...
      <div className="w-24 h-24 md:w-32 md:h-32 rounded-xl overflow-hidden bg-gradient-to-br from-primary to-secondary flex items-center justify-center glow-cyan">
  <img
    src="mrunmai photo.png"
    alt="Mrunmai Girame"
      ...
      <div className="glass p-4 rounded-lg">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">St. Theresa's Girls' School, Bhopal</p>
            <p className="text-sm text-primary">Percentage: 92.6% | May 2019 – May 2020</p>
          </div>
        </div>
      </div>
