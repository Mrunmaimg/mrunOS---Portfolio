...
import { User, FolderCode, Award, Settings, Briefcase, FileText, Mail, Terminal, Activity, Clock, Cloud, Cpu, FolderTree, Gamepad2, Calculator, Grid3x3, Camera, Music, StickyNote, Globe, Image, Brain } from "lucide-react";
...
export const Desktop = () => {
  ...
  const apps = [
    ...
    { id: "ai-assistant", title: "AI.assistant", icon: Brain, component: <AIAssistantWindow /> },
  ];
